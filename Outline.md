...
-   Current Price Toggle: Live comparison of average kWh vs. Liter prices.

-   Savings Calculator: A "What-If" tool to see historical savings based on specific car models/efficiency.

-   A "Buy-Wait" Signal: A color-coded recommendation (Green/Yellow/Red) based on the 48h forecast. This will be based on the user input of how much money they still have left and current and predicted prices for the next days.
...
-   **Modeling:** scikit-learn (Random Forests) and TiRex (xLSTM distillation) for time-series forecasting.
